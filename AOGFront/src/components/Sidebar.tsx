        ...
        <nav className="bg-white shadow-lg h-screen fixed top-0 left-0 min-w-[250px] py-6 px-4 font-[sans-serif] overflow-auto">
            ...
            <ul className="mt-6">
                ...
                <Link to="/"
                    ...
                    <GoogleIcon iconName="dashboard" clsName="w-[18px] h-[18px] mr-4 flex items-center" />
                    <span>Dashboard</span>
                </Link>
                </li>
            </ul>
            ...
            <div className="mt-6">
                ...
                <ul className="mt-3">
                <li>
                    <Link to="/users" className="text-black hover:text-blue-600 text-sm flex items-center hover:bg-blue-50 rounded px-4 py-3 transition-all">
                        <GoogleIcon iconName="group" clsName="w-[18px] h-[18px] mr-4 flex items-center" />
                        <span>Employees</span>
                    </Link>
                </li>
                <li>
                    <Link to="/item-kits"
                    className="text-black hover:text-blue-600 text-sm flex items-center hover:bg-blue-50 rounded px-4 py-3 transition-all">
                        <GoogleIcon iconName="category" clsName="w-[18px] h-[18px] mr-4 flex items-center" />
                        <span>Item Kits</span>
                    </Link>
                </li>
                <li>
                    <Link to="/items" className="text-black hover:text-blue-600 text-sm flex items-center justify-start hover:bg-blue-50 rounded px-4 py-3 transition-all">
                        <GoogleIcon iconName="inventory" clsName="w-[18px] h-[18px] mr-4 flex items-center" />
                        <span>Items</span>
                    </Link>
                </li>
                <li>
            ...
            <div className="mt-6">
                <h6 className="text-blue-600 text-sm font-bold px-4">Reports</h6>
                <ul className="mt-3">
                <li>
                    <a href="#"
                    className="text-black hover:text-blue-600 text-sm flex items-center hover:bg-blue-50 rounded px-4 py-3 transition-all">
            ...
            <div className="mt-6">
                ...
                <li>
                    <a type="button" onClick={()=> setToken(null)}
                    className="text-black hover:text-blue-600 text-sm flex items-center hover:bg-blue-50 rounded px-4 py-3 transition-all">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="w-[18px] h-[18px] mr-4"
